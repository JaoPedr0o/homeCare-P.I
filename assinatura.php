...
<body>
    <h2 class=titulo> Deseja participar da equipe de profissionais capacitados do Vital+?</h2> 
    <p class=texto> Basta assinar o nosso plano! Com ele, você poderá se conectar com pacientes, os ajudando remotamente ou pessoalmente.
    <div class="container">
